...
Если в ответе бэкенд вернул больше чем 10 стран, в интерфейсе появляется
...
Если бэкенд вернул от 2-х до 10-ти стран, под тестовым полем отображается список
